...
**
** Modified by Håkon Hitland, 2011: Changed timer to ARM cycle counter.
**
...
#define CompilerVersion (__ARMCC_VERSION)
...
#endif
    if (!user_enable)
        FatalError("User mode enable is not set, no access to cycle counter\n");
